...
import common.reachit.examtask.Adapter.SectionPagerAdapter;
...
public class HomeFragment extends Fragment {
    ...
    private void setUpViewPager(ViewPager viewPager) {
        ...
        sectionPagerAdapter.addFragment(new AddFragment(),"Add");
        sectionPagerAdapter.addFragment(new DataFragment(),"Data");
